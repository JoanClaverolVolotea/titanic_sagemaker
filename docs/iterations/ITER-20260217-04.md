...
- Se actualizaron `docs/tutorials/03-sagemaker-pipeline.md` y `docs/tutorials/04-serving-ecs-sagemaker.md` con convencion de naming/tagging para cleanup seguro.
